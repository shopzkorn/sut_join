...
class AboutSutjoin extends Component {
  ...
  render() {
    return (
      ...
      <LinearGradient
        ...
        >
          <Image style={{ marginTop: 60,alignSelf: 'center', width: 200, height: 200 }}
            source={require('../../asset/image/logo.png')}
          />
          <Text style={{ fontSize: width / 10, fontWeight: 'bold',color: '#ffffff' ,alignSelf:'center'}}>
                    SUT JOIN
          </Text>
          <Text style={{  marginTop: 60,fontSize: 14,color: '#ffffff' ,alignSelf:'center'}}>
                      SUT Join is application for education
          </Text>
          <Text style={{fontSize: 14,color: '#ffffff' ,alignSelf:'center'}}>
                      in Software Project Course 
          </Text>
          ...
          <Text style={{fontSize: 14,color: '#ffffff' ,alignSelf:'center'}}>
                      Suppanat Theerattananukul
          </Text>
          <Text style={{fontSize: 14,color: '#ffffff' ,alignSelf:'center'}}>
                      Porramat Teayjangread
          </Text>
          <Text style={{fontSize: 14,color: '#ffffff' ,alignSelf:'center'}}>
                      Worasit Ngamsaard
          </Text>
