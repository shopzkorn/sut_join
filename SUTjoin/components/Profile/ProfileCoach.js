...
class Profile extends React.Component {
    ...
    return {
      header: (
        ...
        <View style={[styles.flex, styles.row, styles.header,]}>
          ...
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate('AddCoopActivity')} style={[styles.circleButtun,styles.marginRight]}>
              <Icon name="ios-add-circle" size={20} />
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate('SettingMode')} style={[styles.circleButtun]}>
  ...
  fetchData = async () => {
    ...
    Promise.all([
      fetch('https://it2.sut.ac.th/project62_g4/Web_SUTJoin/include/GetCoachHost.php', {
        method: 'post',
        headers: new Headers({
          'Accept': 'application/json',
          'Content-Type': 'application/json'
              ...
              <Right style={{ justifyContent: 'flex-end' }}>
                <View style={{ flexDirection: 'row' }}>
                  <MaterialCommunityIcons
                    ...
                    color={theme.colors.black}
                  />
                  <Text> {item.joiner}/{item.number_of_seats}</Text>
                </View>
                <Text>{item.meeting_day}</Text>
              </Right>
            </CardItem>
            ...
            <CardItem style={{ paddingVertical: 0 }}>
              ...
              <Right style={{ justifyContent: 'flex-end' }}>
                <TouchableOpacity style={[
                  ...
                  activeOpacity={0.5}
                  onPress={() => navigation.navigate('DetailCoop', { article: item.Id_coop_activity, age_user: this.state.age_user, gender_user: this.state.gender_user })}
                >
                  <Text style={{
                    color: "#fe53bb",
                    fontWeight: 'bold'
