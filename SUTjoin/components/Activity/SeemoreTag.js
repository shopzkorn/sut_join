    ...
    renderItem = (item, index) => {
        return (
            <View style={{ marginHorizontal: 8 }}>
                <TouchableOpacity style={{ paddingVertical: 8, flexDirection: 'row', justifyContent: 'space-between' }} onPress={() =>  {this.props.navigation.state.params.FilterTag(item.activity_tag);
                 this.props.navigation.navigate('SearchActivity')
                }}>
                    <View style={{ marginLeft: 8 ,marginVertical:5}}>
