...
class History extends React.Component {
  ...
  state = {
    ...
    buttonBG: [
      ...
      { button_id: '1', background: require('../../asset/image/Learning.jpg'), backgroundcolor: false, text: 'K1' },
      { button_id: '2', background: require('../../asset/image/Volunteer.jpg'), backgroundcolor: false, text: 'K2' },
      { button_id: '3', background: require('../../asset/image/Recreation.jpg'), backgroundcolor: false, text: 'K3' },
      { button_id: '4', background: require('../../asset/image/Hangout.jpg'), backgroundcolor: false, text: 'K4' },
  ...
  fetchDataSearch = async (status) => {
    ...
    console.log('fecth');
    fetch('https://it2.sut.ac.th/project62_g4/Web_SUTJoin/include/GetCoopActivity.php', {
      method: 'post',
      headers: new Headers({
  ...
  renderItem = (item, index) => {
    ...
    return (
      <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate('DetailCoop', { article: item.Id_coop_activity, age_user: this.state.age_user, gender_user: this.state.gender_user })}>
        <ImageBackground
      ...
      <View style={{marginHorizontal:width/15,}}>
        ...
        <View style={{
          ...
          <Text style={{
            ...
            {item.meeting_day} </Text>
            <Text style={{
            fontSize: theme.sizes.font,
            color: 'white',
            fontWeight: 'bold'
          }}>
            {item.meeting_time_start} - {item.meeting_time_end}</Text>
        </View>
        <View style={{
          justifyContent: 'center',
          ...
          <Text>
            ...
            <Text style={{
              ...
              {item.joiner}/{item.number_of_seats}</Text>
          </Text>
        </View>
        </View>
        <View>
